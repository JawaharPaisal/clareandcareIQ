...
class FastMedicalVisionService:
    """FAST Medical Vision Service - Optimized for speed"""
    ...
    def __init__(self):
        ...
        print(f"FAST Medical Vision Service:")
    ...
    def _preprocess_image(self, image: Image.Image, max_size: int = 512) -> Image.Image:
    ...
    def _load_qwen_fast(self):
        """Load Qwen2-VL with speed optimizations"""
        ...
        try:
            print("   [LOADING] Loading Qwen2-VL (FAST)...")
            ...
            self.qwen_processor = AutoProcessor.from_pretrained(
                ...
                max_pixels=512*28*28  # Smaller for speed
            )
            
            load_time = time.time() - start_time
            print(f"   [OK] Qwen2-VL loaded in {load_time:.1f}s (FAST)")
    ...
    def analyze_medical_image_fast(
        ...
        try:
            ...
            image = self._preprocess_image(image, max_size=512)  # Smaller for speed
    ...
    def _analyze_with_qwen_fast(self, image: Image.Image, document_type: str, timeout: int) -> Dict:
        """FAST Qwen2-VL analysis"""
        try:
            if not self._load_qwen_fast():
            ...
            generation_kwargs = {
                "max_new_tokens": 128,  # Very small for speed
...
Format: MEDICATIONS: [list], PATIENT: [name], DOCTOR: [name]""",
            ...
            "general": """Extract key information:
- Patient details
- Medical conditions
- Test results
- Medications"""
...
# Global instance
fast_vision_service = FastMedicalVisionService()
